...
router.get("/", (req, res) => {
  ...
  <text x="50%" y="38" font-size="25" font-weight="lighter" fill="#7E7F80" anchor="middle">Saldo Acumulado:</text>
  <text x="50%" y="95" font-size="56" font-weight="bolder" fill="#071A2D" anchor="middle">${generado} 
