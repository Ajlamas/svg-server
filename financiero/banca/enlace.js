...
router.get("/", (req, res) => {
  ...
  res.send(`
    <svg xmlns="http://www.w3.org/2000/svg" width="375" height="80" fill="none" viewBox="0 0 375 80">
 ...
 <text x="52" y="60" font-size="12" font-weight="bolder" fill="#071A2D">${clics_unicos} personas 
