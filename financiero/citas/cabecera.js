...
router.get("/", (req, res) => {
  ...
  res.send(`
    <svg width="355" height="141" viewBox="0 0 355 141" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M267 108c0-5.523 4.477-10 10-10h29c5.523 0 10 4.477 10 10v33h-49z" fill="#F4C95D"/>
      <path d="M293 86c0-5.523 4.477-10 10-10h30c5.523 0 10 4.477 10 10v55h-50z" fill="#314150"/>
