...
router.get("/", (req, res) => {
  ...
  res.send(`
    <svg width="355" height="141" viewBox="0 0 355 141" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="12%" y="23" font-size="12" fill="#FFF" font-weight="350" text-anchor="middle">Agendados</text>
      <text x="12%" y="58" font-size="28" fill="#FFF" font-weight="900" text-anchor="middle">${agendados}</text>
      ...
      <text x="60%" y="23" font-size="12" fill="#FFF" font-weight="350" text-anchor="middle">Firmados</text>
      <text x="60%" y="58" font-size="28" fill="#FFF" font-weight="900" text-anchor="middle">${firmados}</text>
